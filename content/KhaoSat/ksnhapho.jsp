    ...
    <div class="box box-primary">
        ...
        <div class="box-body">   
            <div class="col-lg-3">
                ...
                <input type="text" name="np_chieurongmattien" class="form-control" value="" />
            </div> 
            <div class="col-lg-5">
                <label>Đường trước nhà (Nếu đường có lề phải đo luôn lề đường bao nhiêu m?):</label>
                <input type="text" name="np_duongtruocnha" class="form-control" value="" placeholder="" />
            </div> 
            <div class="col-lg-4">
                <label>Vị trí:</label>
                <input type="text" name="np_vitri" class="form-control" value="" placeholder="" />
            </div> 
            <div class="col-lg-4">
                <label>Loại công trình:</label>
                <input type="text" name="np_loaicongtrinh" class="form-control" value="" placeholder="" />
            </div> 
            <div class="col-lg-4">
                <label>Sân nhà:</label>
                <input type="text" name="np_san" class="form-control" placeholder="không chừa sân" value="không chừa sân"/>
            </div> 
        </div>
    </div>
    <div class="box">  
        ...
        <div class="box">  
            <div class="box-body">  
                ...
                <div class="col-lg-4">
                    ...
                    <div class="checkbox">      
                        <label>Khác: </label>
                        <input type="text" name="np_nhavesinh"  placeholder="khác...."/>
                    </div>
                </div>
                
                <div class="col-lg-4">
                    <label>Chất lượng còn lại:</label>
                    <input type="text" name="np_chatluongconlai" class="form-control" value="" />
                </div> 
                <div class="col-lg-4">
