...
<div class="col-md-12" id='block_DT' >   
    <div class="box box-primary">
        <div class="box-header with-border">           
            <h2>Thông Tin Khảo Sát Đất Trống</h2>               
        </div>
        <div class="box-body"> 
            <div class="form-group">
                <label>Hình dáng lô đất:</label>
                 <div class="checkbox">
                    <label>
                        <input type="checkbox" name="dt_hinhdang" checked="" value="<%=objks.getDt_hinhdang()%>" ><%=objks.getDt_hinhdang()%>
                    </label>
                </div>
            ...
            <div class="form-group">
               ...
               <div class="radio">
                    <label><input type="radio" name="dt_huongnha" checked=""  value="<%=objks.getDt_huongnha()%>"    /><%=objks.getDt_huongnha()%> </label>
                </div>
