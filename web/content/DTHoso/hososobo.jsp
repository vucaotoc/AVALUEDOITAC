    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">               
                <h4 class="modal-title" id="myModalLabel">THÊM HỒ SƠ SƠ BỘ</h4>
            </div>
            <!--/.modal-header-->

            <div class="modal-body">
                <form method="post" id="changeFormSubmit" action="themsobo" enctype="multipart/form-data">                      
                    <div class="form-group">
                        <label for="aaaghichu">Ghi chú:</label>
...
<div class="modal fade" id="chitiethssobo_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">               
                <h4 class="modal-title" id="myModalLabel">CHI TIẾT SƠ BỘ <span id="mahsdt" class="badge bg-navy"></span></h4>
            </div>
            <!--/.modal-header-->
            ...
            <div class="modal-footer">          
                ...
                <a href="#" id="xnhuyhsdt" class="btn bg-red  pull-right" style="display: none;" onclick="javascript:alert('Xác nhận hủy hồ sơ sơ bộ ?');">Hủy Hồ Sơ</a>
            ...
            success: function (data) {
                ...
                $.each(data.cths, function (i, item) {
                    ...
                    if (item.tinhtrang === 1) {
                        ...
                        document.getElementById("xnhuyhsdt").href="hosodt?huyhs="+item.iddths;
                    }
