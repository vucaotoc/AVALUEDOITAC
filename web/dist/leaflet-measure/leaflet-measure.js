!function (e) {
    ...
    t.m = e, t.c = r, t.d = function (e, r, n) {
        ...
        L.Control.Measure = L.Control.extend({
            ...
            _initLayout: function () {
                ...
                var n = (0, c.selectOne)(".js-start", t),
                        ...
                        iii = (0, c.selectOne)(".js-delete-last-point", t);


                this.$startPrompt = (0, c.selectOne)(".js-startprompt", t),
                        this.$measuringPrompt = (0, c.selectOne)(".js-measuringprompt", t),
                        this.$startHelp = (0, c.selectOne)(".js-starthelp", t), this.$results = (0, c.selectOne)(".js-results", t),
                        this.$measureTasks = (0, c.selectOne)(".js-measuretasks", t), this._collapse(),
                        this._updateMeasureNotStarted(), L.Browser.android ||
                        (L.DomEvent.on(t, "mouseenter", this._expand, this),
                                L.DomEvent.on(t, "mouseleave", this._collapse, this)),
                        L.DomEvent.on(r, "click", L.DomEvent.stop), L.Browser.touch ? L.DomEvent.on(r, "click", this._expand, this) :
                        ...
                        L.DomEvent.on(iii, "click", L.DomEvent.stop),
                        L.DomEvent.on(iii, "click", this._delelastpoint, this)
            },
            ...
            _finishMeasure: function () {
                ...
                this._locked = !1, L.DomEvent.off(this._container, "mouseover",
                        this._handleMapMouseOut, this), this._clearMeasure(),
                        this._captureMarker.off("mouseout", this._handleMapMouseOut, this).off("dblclick", this._handleMeasureDoubleClick, this).off("click", this._handleMeasureClick, this), this._map.off("mousemove", this._handleMeasureMove, this).off("mouseout", this._handleMapMouseOut, this).off("move", this._centerCaptureMarker, this).off("resize", this._setCaptureMarkerIcon, this), this._layer.removeLayer(this._measureVertexes).removeLayer(this._captureMarker), this._measureVertexes = null, this._updateMeasureNotStarted(), this._collapse(), this._map.fire("measurefinish", e, !1)
            },
            _clearMeasure: function () {
                ...
                this._latlngs = [],
                        ...
                        this._measureDrag && this._layer.removeLayer(this._measureDrag), this._measureArea &&
                        this._layer.removeLayer(this._measureArea), this._measureBoundary &&
                        this._layer.removeLayer(this._measureBoundary), this._measureDrag = null, this._measureArea = null, this._measureBoundary = null
            },
            ...
            _handleMeasureClick: function (e) {
                ...
                r && t.equals(r) || (this._latlngs.push(t), this._addMeasureArea(this._latlngs), this._addMeasureBoundary(this._latlngs),
            ...
            _addMeasureArea: function (e) {
                if (e.length < 3)
                    return void(this._measureArea && (this._layer.removeLayer(this._measureArea), this._measureArea = null));
            ...
            _addMeasureBoundary: function (e) {
                if (e.length < 2)
                    return void(this._measureBoundary && (this._layer.removeLayer(this._measureBoundary), this._measureBoundary = null));
            ...
            _delelastpoint: function (e) {
                //console.log(this._latlngs);
                if (this._latlngs.length > 2) {
                    this._latlngs.splice(-1);
                    //var n = this._symbols.getSymbol("measureVertex");
                    //console.log(this._measureVertexes);
                    //console.log(this._measureVertexes.getLayers().length);
                    //console.log(this._measureVertexes.getLayers()[this._measureVertexes.getLayers().length-1]._leaflet_id);
                    
                    this._measureVertexes.removeLayer(this._measureVertexes.getLayers()[this._measureVertexes.getLayers().length-1]);
                    this._resultsModel = null,
        ...
        e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# \n\
        title="Measure distances and areas">Measure</a> \n\
<div class="{{ model.className }}-interaction js-interaction"> \n\
<div class="js-startprompt startprompt"> <h3>Đo trên bản đồ</h3> \n\
<ul class=tasks> <a href=# class="js-start start">Tạo thước đo</a> </ul> \n\
</div> <div class=js-measuringprompt> <h3>Đo trên bản đồ</h3> \n\
<p class=js-starthelp>Vui lòng chọn điểm trên bản đồ để bắt đầu</p> \n\
<div class="js-results results"></div> <ul class="js-measuretasks tasks"> \n\
<li><a href=# class="js-cancel cancel">Hủy bỏ</a></li> \n\
<li><a href=# class="js-finish finish">Hoàn Thành</a></li></ul> \n\
 <ul class="js-measuretasks tasks"> \n\
<li><a href=# class="js-delete-last-point lastpoint">Xóa tọa độ cuối</a></li> \n\
</ul> </div> </div> '
    }, function (e, t, r) {
        e.exports = '<div class=group> <p class="lastpoint heading">Tọa độ cuối:</p> <p>{{ model.lastCoord.dms.y }}\n\
         <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> \n\
<p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>,</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p>\n\
 </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Tổng chiều dài cạnh:</span> {{ model.lengthDisplay }}</p>\n\
 </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group>\n\
 <p><span class=heading>Diện tích:</span> {{ model.areaDisplay }}2</p> </div> <% } %> '
    }, function (e, t, r) {
        e.exports = '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} \n\
    <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} \n\
<span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> \n\
<ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this location</a></li>\n\
 <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
    }, function (e, t, r) {
        e.exports = '<h3>Linear measurement</h3> <p>{{ model.lengthDisplay }}</p> \n\
    <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> \n\
<li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
    }, function (e, t, r) {
        e.exports = '<h3>Khu vực đo đạc</h3> <p>Diện tích: {{ model.areaDisplay }}2</p> <p>Tổng chiều dài cạnh:{{ model.lengthDisplay }}</p> \n\
        <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Giữa màn hình</a></li>\n\
 <li><a href=# class="js-deletemarkup deletemarkup">Xóa khu vực này</a></li> </ul> '
    }]);