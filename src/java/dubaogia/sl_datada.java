...
@WebServlet(name = "sl_datada", urlPatterns = {"/datada"})
public class sl_datada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("avl_dangnhap") != null) {
            if (request.getParameter("getdubao") != null) {
                ...
                List<objDatagia> arr = DADatagia.getDiachi_ajax(str,"DA");
                ...
                RequestDispatcher dispatcher = request.getServletContext()
                        .getRequestDispatcher("/index.jsp?datada=yes");
