...
L.Util.extend(L.KML, {
  ...
  addPlacePopup: function(place, layer) {
    ...
    if (name) {
      //layer.bindPopup('<h2><a href="hoso?mahs=' + name + '" target="_blank">' + name + '</a></h2>' + descr, { className: 'kml-popup'});
      layer.bindPopup('<h2><a href="hoso?mahs=' + name + '" target="_blank">' + name + '</a></h2>', { className: 'kml-popup'});
    }
  },
