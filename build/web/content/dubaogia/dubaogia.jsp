...
<div class="content-wrapper" style="height: auto;">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">  
                <h1>XEM GIÁ BĐS THEO TUYẾN ĐƯỜNG</h1>
                ...
                <div class="col-md-5">  
                    <div class="card card-info">
                        <div class="card-header with-border">
                            <h3 class="card-title">Nhập tuyến đường </h3>
                        </div>
                        <div class="card-body"> 
                            <div class="form-group">
                                <textarea  class="form-control input-lg"  onkeyup="searchText();"  id="diachixem" placeholder="Vui lòng nhập địa chỉ muốn xem"></textarea> 
                            </div>  
