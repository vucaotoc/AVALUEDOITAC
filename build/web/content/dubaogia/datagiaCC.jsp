                ...
                <div class="col-md-5">  
                    <div class="card card-info">
                        <div class="card-header with-border">
                            <h3 class="card-title">Nhập tên các dự án căn hộ</h3>
                        </div>
                        <div class="card-body"> 
                            <div class="form-group">
                                <textarea  class="form-control input-lg"  onkeyup="searchText();"  id="diachixem" placeholder="Vui lòng tên các dự án căn hộ muốn xem"></textarea> 
                            </div>  
